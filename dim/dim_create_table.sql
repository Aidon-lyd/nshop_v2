create table if not exists 1902_tzg_dim_nshop.dim_pub_category (
...
create table if not exists 1902_tzg_dim_nshop.dim_pub_supplier(
...
location '/data/tzg/dim/dim_pub_supplier/';

create table if not exists 1902_tzg_dim_nshop.dim_pub_product(
...
location '/data/tzg/dim/dim_pub_product/';

create table if not exists 1902_tzg_dim_nshop.dim_pub_page (
...
location '/data/tzg/dim/dim_pub_page/';

create table if not exists 1902_tzg_dim_nshop.dim_pub_area (
...
location '/data/tzg/dim/dim_pub_area/';

create table if not exists 1902_tzg_dim_nshop.dim_pub_date (
...
location '/data/tzg/dim/dim_pub_date/';

create table if not exists 1902_tzg_dim_nshop.dim_pub_comm (
...
location '/data/tzg/dim/dim_pub_comm/';
