drop table if exists 1902_wm_dim_nshop.dim_pub_category;
drop table if exists 1902_wm_dim_nshop.dim_pub_supplier;
drop table if exists 1902_wm_dim_nshop.dim_pub_product;
drop table if exists 1902_wm_dim_nshop.dim_pub_page;
drop table if exists 1902_wm_dim_nshop.dim_pub_area;
drop table if exists 1902_wm_dim_nshop.dim_pub_date;
drop table if exists 1902_wm_dim_nshop.dim_pub_comm;


create external table if not exists 1902_wm_dim_nshop.dim_pub_category (
...
LINES TERMINATED BY '\n'
location '/data/wangmeng/nshop/dim/dim_pub_category/';

create external table if not exists  1902_wm_dim_nshop.dim_pub_supplier(
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\n'
location '/data/wangmeng/nshop/dim/dim_pub_supplier/';

create external table if not exists 1902_wm_dim_nshop.dim_pub_product(
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\n'
location '/data/wangmeng/nshop/dim/dim_pub_product/';

create external table if not exists 1902_wm_dim_nshop.dim_pub_page (
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\n'
location '/data/wangmeng/nshop/dim/dim_pub_page/';

create external table if not exists 1902_wm_dim_nshop.dim_pub_area (
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\n'
location '/data/wangmeng/nshop/dim/dim_pub_area/';

create external table if not exists 1902_wm_dim_nshop.dim_pub_date (
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\n'
location '/data/wangmeng/nshop/dim/dim_pub_date/';

create external table if not exists 1902_wm_dim_nshop.dim_pub_comm (
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\n'
location '/data/wangmeng/nshop/dim/dim_pub_comm/';
