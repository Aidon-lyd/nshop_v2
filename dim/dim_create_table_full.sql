drop table if exists 1902_lp_dim_nshop.dim_pub_category;
drop table if exists 1902_lp_dim_nshop.dim_pub_supplier;
drop table if exists 1902_lp_dim_nshop.dim_pub_product;
drop table if exists 1902_lp_dim_nshop.dim_pub_page;
drop table if exists 1902_lp_dim_nshop.dim_pub_area;
drop table if exists 1902_lp_dim_nshop.dim_pub_date;
...
location '/data/liupei/nshop/dim/dim_pub_comm/';
