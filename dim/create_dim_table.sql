-- 商品分类表
create table if not exists 1902_g1_dim_nsshop.dim_pub_category (
...
location '/1902_g1_nsshop/dim/dim_pub_category/';

-- 供应商信息表
create table if not exists  1902_g1_dim_nsshop.dim_pub_supplier(
...
location '/1902_g1_nsshop/dim/dim_pub_supplier/';


-- 商品信息表
create table if not exists 1902_g1_dim_nsshop.dim_pub_product(
...
location '/1902_g1_nsshop/dim/dim_pub_product/';

-- 页面布局
create table if not exists 1902_g1_dim_nsshop.dim_pub_page (
...
location '/1902_g1_nsshop/dim/dim_pub_page/';

-- 地域表
create table if not exists 1902_g1_dim_nsshop.dim_pub_area (
...
location '/1902_g1_nsshop/dim/dim_pub_area/';

-- 日期维度表
create table if not exists 1902_g1_dim_nsshop.dim_pub_date (
...
location '/1902_g1_nsshop/dim/dim_pub_date/';

-- 通用维表
create table if not exists 1902_g1_dim_nsshop.dim_pub_comm (
...
location '/1902_g1_nsshop/dim/dim_pub_comm/';
