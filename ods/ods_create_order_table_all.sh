create table if not exists 1902_wm_ods_nshop.ods_nshop_02_orders (
...
LINES TERMINATED BY '\n'
location '/data/wangmeng/nshop/ods/ods_nshop_02_orders/';

create table if not exists 1902_wm_ods_nshop.ods_nshop_02_order_detail(
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
location '/data/wangmeng/nshop/ods/ods_nshop_02_order_detail/';

create table if not exists 1902_wm_ods_nshop.ods_nshop_02_orders_pay_records (
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
location '/data/wangmeng/nshop/ods/ods_nshop_02_orders_pay_records/';
