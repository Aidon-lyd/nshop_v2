create external table if not exists 1902_zx_nshop_ods.ods_01_releasedatas(
...
stored as textfile
location '/data/nshop/ods/release_zx/';

alter table 1902_zx_nshop_ods.ods_01_releasedatas add partition (bdp_day='20191119');
