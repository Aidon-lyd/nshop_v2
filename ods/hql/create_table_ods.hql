...
location '/data/1902_zx/nshop/ods/ods_nshop_02_customer/';
...
location '/data/1902_zx/nshop/ods/ods_nshop_02_customer_consignee/';
...
create external table if not exists ods_nshop_02_orders (
...
LINES TERMINATED BY '\n'
location '/data/1902_zx/nshop/ods/ods_nshop_02_orders/';


-- 订单详情表

create external table if not exists ods_nshop_02_order_detail(
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
location '/data/1902_zx/nshop/ods/ods_nshop_02_order_detail/';

-- 订单支付记录表

create external table if not exists ods_nshop_02_orders_pay_records (
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
location '/data/1902_zx/nshop/ods/ods_nshop_02_orders_pay_records/';
