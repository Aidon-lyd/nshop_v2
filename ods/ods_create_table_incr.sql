...
create external table if not exists 1902_lp_ods_nshop.ods_nshop_02_orders (
...
create external table if not exists 1902_lp_ods_nshop.ods_nshop_02_order_detail(
...
create external table if not exists 1902_lp_ods_nshop.ods_nshop_02_orders_pay_records (
