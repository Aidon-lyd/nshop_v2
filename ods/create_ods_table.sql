-- 创建ods的用户基本信息表
create table if not exists 1902_g1_ods_nsshop.ods_nshop_02_customer (
...
location '/1902_g1_nsshop/ods/ods_nshop_02_customer/';

-- 收货地址管理表
create table if not exists 1902_g1_ods_nsshop.ods_nshop_02_customer_consignee (
