...
create external table if not exists 1902_lp_ods_nshop.ods_nshop_02_customer (
...
create external table if not exists 1902_lp_ods_nshop.ods_nshop_02_customer_consignee (
