drop table if exists 1902_lp_ods_nshop.ods_nshop_02_customer;
drop table if exists 1902_lp_ods_nshop.ods_nshop_02_customer_consignee;
drop table if exists 1902_lp_ods_nshop.ods_nshop_02_orders;
drop table if exists 1902_lp_ods_nshop.ods_nshop_02_order_detail;
drop table if exists 1902_lp_ods_nshop.ods_nshop_02_orders_pay_records;

create table if not exists 1902_lp_ods_nshop.ods_nshop_02_customer (
...
location '/data/liupei/nshop/ods/ods_nshop_02_customer/';

create table if not exists 1902_lp_ods_nshop.ods_nshop_02_customer_consignee (
...
location '/data/liupei/nshop/ods/ods_nshop_02_customer_consignee/';

create table if not exists 1902_lp_ods_nshop.ods_nshop_02_orders (
...
location '/data/liupei/nshop/ods/ods_nshop_02_orders/';

create table if not exists 1902_lp_ods_nshop.ods_nshop_02_order_detail(
...
location '/data/liupei/nshop/ods/ods_nshop_02_order_detail/';

create table if not exists 1902_lp_ods_nshop.ods_nshop_02_orders_pay_records (
...
location '/data/liupei/nshop/ods/ods_nshop_02_orders_pay_records/';
