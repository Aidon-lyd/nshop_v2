create table if not exists 1902_gxj_dim_nshop.dim_pub_category1 (
...
location '/data/nshop/dim/dim_pub_category1/';
...
create table if not exists  1902_gxj_dim_nshop.dim_pub_supplier1(
...
location '/data/nshop/dim/dim_pub_supplier1/';
...
create table if not exists 1902_gxj_dim_nshop.dim_pub_product1(
...
location '/data/nshop/dim/dim_pub_product1/';
...
create table if not exists 1902_gxj_dim_nshop.dim_pub_page1 (
...
location '/data/nshop/dim/dim_pub_page1/';
...
create table if not exists 1902_gxj_dim_nshop.dim_pub_area1 (
...
location '/data/nshop/dim/dim_pub_area1/';
...
create table if not exists 1902_gxj_dim_nshop.dim_pub_date1 (
...
location '/data/nshop/dim/dim_pub_date1/';
...
create table if not exists 1902_gxj_dim_nshop.dim_pub_comm1 (
...
location '/data/nshop/dim/dim_pub_comm1/';
