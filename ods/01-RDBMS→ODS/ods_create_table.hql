...
-- 用户基本信息表
create table if not exists 1902_zrb_nshop_ods.ods_nshop_02_customer (
...
-- 收货地址管理表
create table if not exists 1902_zrb_nshop_ods.ods_nshop_02_customer_consignee (
...
-- 订单表
create table if not exists 1902_zrb_nshop_ods.ods_nshop_02_orders (
...
-- 订单详情表
create table if not exists 1902_zrb_nshop_ods.ods_nshop_02_order_detail(
...
-- 订单支付记录表
create table if not exists 1902_zrb_nshop_ods.ods_nshop_02_orders_pay_records (
