...
--   商品分类表
create table if not exists 1902_zrb_nshop_dim.dim_pub_category (
...
create table if not exists  1902_zrb_nshop_dim.dim_pub_supplier(
...
create table if not exists 1902_zrb_nshop_dim.dim_pub_product(
...
create table if not exists 1902_zrb_nshop_dim.dim_pub_page (
...
create table if not exists 1902_zrb_nshop_dim.dim_pub_area (
...
create table if not exists 1902_zrb_nshop_dim.dim_pub_date (
...
create table if not exists 1902_zrb_nshop_dim.dim_pub_comm (
