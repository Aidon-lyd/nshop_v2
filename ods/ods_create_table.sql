create table if not exists 1902_tzg_ods_nshop.ods_nshop_02_customer (
...
location '/data/tzg/ods/ods_nshop_02_customer/';

create table if not exists 1902_tzg_ods_nshop.ods_nshop_02_customer_consignee (
...
location '/data/tzg/ods/ods_nshop_02_customer_consignee/';

create table if not exists 1902_tzg_ods_nshop.ods_nshop_02_orders (
...
location '/data/tzg/ods/ods_nshop_02_orders/';

create table if not exists 1902_tzg_ods_nshop.ods_nshop_02_order_detail(
...
location '/data/tzg/ods/ods_nshop_02_order_detail/';

create table if not exists 1902_tzg_ods_nshop.ods_nshop_02_orders_pay_records (
...
location '/data/tzg/ods/ods_nshop_02_orders_pay_records/';
