...
--创建表
--用户基本信息表
create table if not exists 1902_zs_ods_nshop.ods_nshop_02_customer (
...
location '/data/zhoushuai/ods/ods_customer';
--收货地址管理表
create table if not exists 1902_zs_ods_nshop.ods_nshop_02_customer_consignee (
...
location '/data/zhoushuai/ods/customer_consignee/';
--订单表
create table if not exists 1902_zs_ods_nshop.ods_nshop_02_orders (
...
location '/data/zhoushuai/ods/orders/';
--订单详情表
create table if not exists 1902_zs_ods_nshop.ods_nshop_02_order_detail(
...
location '/data/zhoushuai/ods/order_detail/';
--订单支付记录表
create table if not exists 1902_zs_ods_nshop.ods_nshop_02_orders_pay_records (
...
location '/data/zhoushuai/ods/orders_pay_records/';
--维表

--商品分类表
create table if not exists 1902_zs_dim_nshop.dim_pub_category (
...
location '/data/zhoushuai/dim/pub_category/';
--供应商信息表
create table if not exists  1902_zs_dim_nshop.dim_pub_supplier(
...
location '/data/zhoushuai/dim/pub_supplier/';
--商品信息表
create table if not exists 1902_zs_dim_nshop.dim_pub_product(
...
location '/data/zhoushuai/dim/pub_product/';
--页面布局
create table if not exists 1902_zs_dim_nshop.dim_pub_page (
...
location '/data/zhoushuai/dim/pub_page/';
--地域表
create table if not exists 1902_zs_dim_nshop.dim_pub_area (
...
location '/data/zhoushuai/dim/pub_area/';
--日期维度表
create table if not exists 1902_zs_dim_nshop.dim_pub_date (
...
location '/data/zhoushuai/dim/pub_date/';
--通用维表
create table if not exists 1902_zs_dim_nshop.dim_pub_comm (
...
location '/data/zhoushuai/dim/pub_comm/';
...
location '/BigData_1902/zhoushuai/dim/pub_date/';
